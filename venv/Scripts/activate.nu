...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ilyar\PycharmProjects\pythonProject_password\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ilyar\PycharmProjects\pythonProject_password\venv\Scripts\deactivate.nu'
